...
conut_start_step = 1.35 # Million iterations
...
if __name__ == "__main__":
    data_file = "./data/mdsacth25e/run_data.json"
    save_path = "./figures/mdsacth25e"
    #env_list = ["gym_bipedalwalker"]
    env_list = ['gym_ant',"gym_walker2d",'gym_halfcheetah','gym_humanoid']
    #env_list = ['gym_humanoid','gym_inverteddoublependulum','gym_reacher','gym_ant',"gym_walker2d",'gym_halfcheetah',"gym_bipedalwalker","gym_pusher",'gym_hopper','gym_swimmer']
    #alg_list = ['MDSACTH25']
    alg_list = ['MDSACTH25E','DSAC-T','DSAC-v1','SAC','TD3','DDPG','TRPO','PPO']
