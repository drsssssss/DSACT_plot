...
def plot_performance(
    ...
    for idx,env in enumerate(env_list):
        ...
        #colors = [ '#377EB8', '#4DAF4A', '#984EA3', '#FF7F00', '#FFFF33', '#A65628','#E41A1C']   #back-up
        #colors = [ '#E41A1C','#984EA3', '#FF7F00', '#FFFF33', '#A65628','#4DAF4A','#377EB8']
...
if __name__ == "__main__":
    data_file = "./data/dsacticm/run_data.json"
    #data_file = "./data/huamoid.json"
    save_path = "./figures/dsacticm"
    os.makedirs(save_path, exist_ok=True)
    #env_list = ["gym_halfcheetah", "gym_ant", "gym_humanoid", "gym_inverteddoublependulum","gym_reacher","gym_bipedalwalker","gym_pusher","gym_hopper","gym_swimmer","gym_walker2d"]
    env_list = ["gym_halfcheetah", "gym_ant"]
