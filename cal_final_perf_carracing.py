...
conut_start_step = 0.15 # Million iterations
...
if __name__ == "__main__":
    data_file = "./data/carracing/run_data.json"
    save_path = "./figures/carracing/"
    env_list = ["gym_carracingraw"]
    # alg_list = ['DSACT','SAC','TD3','DDPG','PPO']
    # alg_list = ['DSAC-T']
