...
#source_path ="/home/go/桌面/GOPS-dsac-t/results/mujoco"
source_path ="/home/go/桌面/XLM/GOPS-dsac-t/results/mujoco/transfer"
...
target_path = "dsacticm"
os.makedirs(target_path,exist_ok=True)
#algs = ['dsact','dsac','sac','ppo','trpo','td3','ddpg']
algs = ['dsacticm']
apprfuncs = ['mlp']
envs=["gym_ant", "gym_halfcheetah"]
...
for alg, appr, env in itertools.product(algs,apprfuncs,envs):
    ...
    for floder in os.listdir(source_dir):
        if  floder.startswith(env) and floder.endswith("0307_run0"): #houzui
